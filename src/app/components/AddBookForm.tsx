...
const AddBookForm: React.FC<AddBookFormProps> = ({ onAddBook }) => {
  ...
  return (
    <div className="min-h-screen bg-[#EFEBFF] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 rounded-xl">
      <div className="max-w-2xl w-full bg-white shadow-lg rounded-lg p-8 space-y-6">
        <h1 className="text-2xl font-extrabold text-gray-900 text-center">Add a New Book</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="border border-[#D9D9D9] rounded-lg p-3 w-full focus:outline-none focus:border-blue-600 transition-all duration-300"
              required
            />
          </div>
